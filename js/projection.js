...
export class OffAxisProjection {
    ...
    apply(eyePos, camera) {
        ...
        const e = m.elements;
        e[0] = this._vr.x; e[4] = this._vr.y; e[8]  = this._vr.z; e[12] = 0;
        e[1] = this._vu.x; e[5] = this._vu.y; e[9]  = this._vu.z; e[13] = 0;
        e[2] = this._vn.x; e[6] = this._vn.y; e[10] = this._vn.z; e[14] = 0;
    ...
    faceToEyePosition(normX, normY, distZ, sensitivity = 1.0) {
        ...
        // normX is mirrored (webcam mirror), so 0.5 = center
        const x = (normX - 0.5) * this.screenWidth * sensitivity + this.camOffsetX;
        const y = -(normY - 0.5) * this.screenHeight * sensitivity + this.camOffsetY;
